...
<!-- Mirrored from html/change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Sep 2024 06:17:28 GMT -->
<head>
<meta charset="utf-8">
...
<div class="form-group">
<div class="pass-group group-img">
<i class="toggle-password-confirm feather-eye"></i>
<input type="password" class="form-control pass-confirm" placeholder="Confirm Password">
</div>
</div>
<a href="login.html" class="btn btn-secondary w-100 d-inline-flex justify-content-center align-items-center">Change Password<i class="feather-arrow-right-circle ms-2"></i></a>
</form>
...
<script src="assets/js/jquery-3.7.0.min.js" type="dabc7a966bfd1c74f3f40a16-text/javascript"></script>

<script src="assets/js/bootstrap.bundle.min.js" type="dabc7a966bfd1c74f3f40a16-text/javascript"></script>

<script src="assets/plugins/select2/js/select2.min.js" type="dabc7a966bfd1c74f3f40a16-text/javascript"></script>

<script src="assets/js/script.js" type="dabc7a966bfd1c74f3f40a16-text/javascript"></script>
<script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="dabc7a966bfd1c74f3f40a16-|49" defer></script></body>
