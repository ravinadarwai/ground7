...
<body>
                                    ...
                                    <div class="h-100 d-flex justify-content-center align-items-center">
                                        <div class="text-bg register text-center">
                                            <button type="button" class="btn btn-limegreen text-capitalize"><i
                                                    class="fa-solid fa-thumbs-up me-3"></i>User Login</button>
                                            <p>Log in right away for our advanced sports software solutions, created to
                                                address issues in regular sporting events and activities.</p>
                                            <a href="<?php echo (isset($_SESSION['prev_page'])) ? $_SESSION['prev_page'] : '../index.php'; ?>"
                                                class="btn btn-secondary register-btn d-inline-flex justify-content-center align-items-center w-100 btn-block mt-3"
                                                style="font-size: 14px; padding: 0.5rem 1rem;" type="button">
                                                Back
                                ...
                                <div class="col-sm-10 col-md-10 col-lg-10 mx-auto">
                                    <header class="text-center">
                                        <a href="user-dashboard.html">
                                            <img style="height: 11dvh;width: 6rem; object-fit: cover;margin-left: 3rem;"
                                                src="assets/img/Group 100.svg" class="img-fluid" alt="Logo" />
                                        </a>

                                    </header>

                                    <div class="tab-container">
                                        <button id="emailTab" class="tab-button" onclick="showTab('email')">Login with
                                            Email</button>
                                        <button id="numberTab" class="tab-button" onclick="showTab('number')">Login with
                                            Phone</button>
                                    </div>
                                    ...
                                    <div>
                                        <a href="google-login.php" class="btn btn-danger btn-block">Login with
                                            Google</a>
                                        <a href="facebook-login.php" class="btn btn-primary btn-block">Login with
                                            Facebook</a>
                                    </div>
    ...
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="de2c9db6d73847786f25645d-|49" defer></script>
</body>
