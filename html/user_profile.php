...
.profile-circle img {
    width: 100%;
    height: 100%;
    object-fit: cover; /* Ensures image is properly cropped to fit the circle */
}

/* Optional Styling for Fallback Image */
.profile-circle img[alt="Profile Picture"] {
    ...
    <div class="col-sm-12">
        <div class="profile-detail-blk">
            <ul class="nav nav-pills mb-3">
                <li class="nav-item">
                    <a class="nav-link active" href="coach-profile.html">Profile Details</a>
                </li>
            </ul>
        </div>
        ...
        <div class="card shadow-sm p-4">
            ...
            <div class="row">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $turf_owner['name'] ?? ''; ?>" placeholder="Enter Full Name" required>
                            </div>

                            <!-- Email -->
                            <div class="col-lg-6">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email" name="email" value="<?php echo $turf_owner['email'] ?? ''; ?>" placeholder="Enter Email Address" required>
                            </div>

                            <!-- Phone Number -->
                            <div class="col-lg-6">
                                <label for="phone" class="form-label">Phone Number</label>
                                <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $turf_owner['phone'] ?? ''; ?>" placeholder="Enter Phone Number" required>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-select" id="gender" name="gender" required>
                                    ...
                                    <option value="Male" <?php echo isset($turf_owner['gender']) && $turf_owner['gender'] == 'Male' ? 'selected' : ''; ?>>Male</option>
                                    <option value="Female" <?php echo isset($turf_owner['gender']) && $turf_owner['gender'] == 'Female' ? 'selected' : ''; ?>>Female</option>
                                    <option value="Other" <?php echo isset($turf_owner['gender']) && $turf_owner['gender'] == 'Other' ? 'selected' : ''; ?>>Other</option>
                                </select>
                            </div>
                        </div>
                ...
                <!-- Profile Picture Display (Right Side) -->
                <div class="col-lg-6 text-center">
                    <h5 class="text-primary">Your Profile Picture</h5>
                    <div class="profile-circle">
                        <img src="<?php echo !empty($turf_owner['profile_picture']) ? 'path/to/images/' . $turf_owner['profile_picture'] : 'path/to/unknown-profile.jpg'; ?>" alt="Profile Picture" class="img-fluid rounded-circle">
                    </div>
                </div>
            </div>
        </div>
