...
<!-- Mirrored from html/add-court.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Sep 2024 06:16:17 GMT -->
...
<body>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <form action="#" class="accordion" id="accordionPanel">
                            <div class="accordion-item mb-4" id="basic-info">
                                <h4 class="accordion-header" id="panelsStayOpen-basic-info">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseOne">Basic Info
                                    </button>
                                </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space mb-0">
                                                    <label for="court-name" class="form-label">Court Name
                                                        <span>*</span></label>
                                                    <input type="text" class="form-control" id="court-name"
                                                        placeholder="Enter Court Name">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space mb-0">
                                                    <label class="form-label">Court Type <span>*</span></label>
                                                    <select class="select">
                            ...
                            <div class="accordion-item mb-4" id="venue-price">
                                <h4 class="accordion-header" id="panelsStayOpen-venue-price">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseTwo">Venue Price <span>(USD)</span>
                                    </button>
                                </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space">
                                                    <label for="starting-price" class="form-label">Starting Price (Per
                                                        Hour)</label>
                                                    <input type="text" class="form-control" id="starting-price"
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space">
                                                    ...
                                                    <input type="text" class="form-control" id="max-guests"
                                                        placeholder="Enter Max Number of Guests">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space mb-0">
                                                    <label for="additional-guests" class="form-label">Additional
                                                        Guests</label>
                                                    <input type="text" class="form-control" id="additional-guests"
                                                        placeholder="No Additional Guests">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="input-space mb-0">
                                                    <label for="name" class="form-label">Price of Extra Guest (Per
                                                        Hour)</label>
                            ...
                            <div class="accordion-item mb-4" id="availability">
                                <h4 class="accordion-header" id="panelsStayOpen-availability">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseThree">Availability
                                    </button>
                                </h4>
                                                ...
                                                <div class="profile-availability">
                                                        ...
                                                        <ul class="day-list">
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_1" name="day" checked>
                                                                    <label for="select_days_1">
                                                                        Mon
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_2" name="day">
                                                                    <label for="select_days_2">
                                                                        Tues
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_3" name="day">
                                                                    <label for="select_days_3">
                                                                        Wed
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_4" name="day">
                                                                    <label for="select_days_4">
                                                                        Thur
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_5" name="day">
                                                                    <label for="select_days_5">
                                                                        Fri
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_6" name="day">
                                                                    <label for="select_days_6">
                                                                        Sat
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="day-selection">
                                                                    <input type="checkbox" value="attach_link"
                                                                        id="select_days_7" name="day">
                                                                    <label for="select_days_7">
                                                                        Sun
                                                                    </label>
                                                                </div>
                                                            </li>
                                                    ...
                                                    <div class="accordion setting-accordion">
                                                        ...
                                                        <div class="accordion-item" id="day-monday">
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    data-bs-toggle="collapse" data-bs-target="#monday">
                                                                    <div class="interset-btn empty-space">
                                                                        <div
                                                                            class="status-toggle d-inline-flex align-items-center">
                                                                    ...
                                                                    <span class="accord-title">Monday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                            <div id="monday" class="accordion-collapse collapse">
                                                                <div class="accordion-body">
                                                                    <div class="row gx-2">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="duration-blk">
                                                                                <label class="form-control-label">Start
                                                                                    Time <span
                                                                                        class="text-danger">*</span></label>
                                                                                <div class="form-icon">
                                                                                    <input type="text"
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="duration-blk">
                                                                                <label class="form-control-label">End
                                                                                    Time <span
                                                                                        class="text-danger">*</span></label>
                                                                                <div class="form-icon">
                                                                                    <input type="text"
                                                                            ...
                                                                            <div class="token-slot mt-2">
                                                                                <div
                                                                                    ...
                                                                                    <label class="visit-btns">
                                                                                        <input type="checkbox"
                                                                                            ...
                                                                                            value="18">
                                                                                        <span class="visit-rsn"
                                                                                            data-bs-toggle="tooltip"
                                                                                            title="06:00 AM">06:00
                                                                                            AM</span>
                                                                                    </label>
                                                                                </div>
                                                                                <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label class="visit-btns">
                                                                                        ...
                                                                                        <span class="visit-rsn"
                                                                                            data-bs-toggle="tooltip"
                                                                                            title="07:00 PM">07:00
                                                                                            PM</span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class=" save-time">
                                                                                <a href="#">Save Timings</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="accordion-item" id="day-tuesday">
                                                            <div class="accordion-header">
                                                                <div class="accordion-button" data-bs-toggle="collapse"
                                                                    ...
                                                                    <span class="accord-title">Tuesday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="accordion-item" id="day-wednesday">
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    ...
                                                                    <span class="accord-title">Wednesday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    ...
                                                                    <div class="interset-btn empty-space">
                                                                        <div
                                                                            class="status-toggle d-inline-flex align-items-center">
                                                                            <input type="checkbox" id="status_4"
                                                                                class="check">
                                                                            <label for="status_4"
                                                                                class="checktoggle">checkbox</label>
                                                                        </div>
                                                                    </div>
                                                                    <span class="accord-title">Thursday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="accordion-item" id="day-friday">
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    data-bs-toggle="collapse" data-bs-target="#friday">
                                                                    <div class="interset-btn empty-space">
                                                                        <div
                                                                            class="status-toggle d-inline-flex align-items-center">
                                                                            <input type="checkbox" id="status_5"
                                                                                class="check">
                                                                            <label for="status_5"
                                                                                class="checktoggle">checkbox</label>
                                                                        </div>
                                                                    </div>
                                                                    <span class="accord-title">Friday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    ...
                                                                    <div class="interset-btn empty-space">
                                                                        <div
                                                                            class="status-toggle d-inline-flex align-items-center">
                                                                            <input type="checkbox" id="status_6"
                                                                                class="check">
                                                                            <label for="status_6"
                                                                                class="checktoggle">checkbox</label>
                                                                        </div>
                                                                    </div>
                                                                    <span class="accord-title">Saturday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="accordion-item" id="day-sunday">
                                                            <div class="accordion-header">
                                                                <div class="accordion-button collapsed"
                                                                    data-bs-toggle="collapse" data-bs-target="#sunday">
                                                                    <div class="interset-btn empty-space">
                                                                        <div
                                                                            class="status-toggle d-inline-flex align-items-center">
                                                                            <input type="checkbox" id="status_7"
                                                                                class="check">
                                                                            <label for="status_7"
                                                                                class="checktoggle">checkbox</label>
                                                                        </div>
                                                                    </div>
                                                                    <span class="accord-title">Sunday</span>
                                                                    <a href="#">Edit</a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="save-changes text-sm-end">
                                                        <a href="javascript:;"
                                                            class="btn btn-primary reset-profile">Reset</a>
                                                        <a href="javascript:;"
                                                            class="btn btn-secondary save-profile">Save Change</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="accordion-item mb-4" id="overview">
                                <h4 class="accordion-header" id="panelsStayOpen-overview">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseFour">Venue Overview
                                    </button>
                                </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class>
                                                    ...
                                                    <textarea class="form-control" id="venue-overview" rows="9"
                            ...
                            <div class="accordion-item mb-4" id="includes">
                                <h4 class="accordion-header" id="panelsStayOpen-includes">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseFive">Includes
                                    </button>
                                </h4>
                                        ...
                                        <ul class="clearfix">
                                                ...
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    <div class="d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value
                                                            id="includes1" checked>
                                                    </div>
                                                    <label class="form-check-label" for="includes1">Badminton Racket
                                                        Unlimited</label>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    <div class="d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value
                                                            id="includes3" checked>
                                                    </div>
                                                    <label class="form-check-label" for="includes3">Hitting
                                                        Machines</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    <div class="d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value
                                                            id="includes4" checked>
                                                    </div>
                                                    <label class="form-check-label" for="includes4">Multiple
                                                        Courts</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    <div class="d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value
                                                            id="includes5" checked>
                                                    </div>
                                                    <label class="form-check-label" for="includes5">Spare
                                                        Players</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    ...
                                                    <label class="form-check-label" for="includes6">Instant
                                                        Racket</label>
                                                </div>
                                            </li>
                                            <li>
                            ...
                            <div class="accordion-item mb-4" id="rules">
                                <h4 class="accordion-header" id="panelsStayOpen-rules">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseSix">Venue Rules
                                    </button>
                                </h4>
                                <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="input-space">
                                                    <input type="text" class="form-control rules-option" id="add-rules"
                                                        placeholder="Enter Rules">
                                                </div>
                                                <div class="alert alert-danger error-add-rule">Input filed doesn't
                                                    empty, must fill out the rule!</div>
                                                <ul class="rules-wraper"></ul>
                                                <a class="align-items-center add-rules"><i
                                                        class="feather-plus-circle"></i>Add Rules</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item mb-4" id="amenities">
                                <h4 class="accordion-header" id="panelsStayOpen-amenities">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseSeven">Amenities
                                    </button>
                                </h4>
                                        ...
                                        <ul class="d-md-flex align-items-center">
                                            ...
                                            <li>
                                                <div class="form-check d-flex justify-content-start align-items-center">
                                                    <div class="d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value
                                                            id="amenities2" checked>
                                                    </div>
                                                    <label class="form-check-label" for="amenities2">Drinking
                                                        Water</label>
                                                </div>
                                            </li>
                                            <li>
                            ...
                            <div class="accordion-item mb-4" id="gallery">
                                <h4 class="accordion-header" id="panelsStayOpen-gallery">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseEight">Gallery
                                    </button>
                                </h4>
                                                ...
                                                <div class="file-upload-text appointment-upload">
                                                    <div class="input-space">
                                                        ...
                                                        <div class="file-upload">
                                                            <img src="assets/img/icons/upload-icon.svg"
                                                    ...
                                                    <div class="upload-show-img">
                                                        <div class="upload-images">
                                                            <img src="assets/img/booking/booking-01.jpg" alt="Image">
                                                            <a href="javascript:void(0);"
                                                                class="btn btn-icon logo-hide-btn btn-sm"><i
                                                                    class="far fa-trash-alt"></i></a>
                                                        </div>
                                                        <div class="upload-images">
                                                            <img src="assets/img/booking/booking-02.jpg" alt="Image">
                                                            <a href="javascript:void(0);"
                                                                class="btn btn-icon logo-hide-btn btn-sm"><i
                                                                    class="far fa-trash-alt"></i></a>
                                                        </div>
                                                        <div class="upload-images">
                                                            <img src="assets/img/booking/booking-03.jpg" alt="Image">
                                                            <a href="javascript:void(0);"
                                                                class="btn btn-icon logo-hide-btn btn-sm"><i
                                                                    class="far fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                    <h5>Put the main picture as first Image <br> Image Should be minimum
                                                        152 * 152 Supported File format JPG,PNG,SVG</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="accordion-item" id="location">
                                <h4 class="accordion-header" id="panelsStayOpen-location">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="panelsStayOpen-collapseNine">Location
                                    </button>
                                </h4>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="google-maps">
                                                <iframe
                                                    ...
                                                    height="445" style="border:0;" allowfullscreen loading="lazy"
                            ...
                            <div class="text-center btn-row">
                                <a class="btn btn-secondary btn-icon" href="cage-order-confirm.php">Save Venue <i
    ...
    <script src="assets/js/jquery-3.7.0.min.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>

    <script src="assets/plugins/select2/js/select2.min.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>

    <script src="assets/plugins/owl-carousel/owl.carousel.min.js"
        type="e7f75e77f5ea49b654eca19f-text/javascript"></script>

    <script src="assets/js/moment.min.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>
    ...
    <script src="assets/js/script.js" type="e7f75e77f5ea49b654eca19f-text/javascript"></script>
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="e7f75e77f5ea49b654eca19f-|49" defer></script>
</body>

<!-- Mirrored from html/add-court.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Sep 2024 06:16:22 GMT -->
